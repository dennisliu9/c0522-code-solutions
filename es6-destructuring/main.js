...
const { title: secondTitle, author: secondAuthor, libraryID: secondLibraryID } = book2;

console.log(`The title of the book is ${secondTitle}, the author is ${secondAuthor}, and the library id is ${secondLibraryID}`);
